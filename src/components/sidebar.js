      ...
      <nav className="flex-1 space-y-4">
        ...
        >
          {({ isActive }) => (
            <>
              <div className={`${isActive ? "bg-white text-systemYellow-400" : "text-brandNeutral-text"} p-2 rounded-full transition-colors`}>
                <BookOpen size={20} className={!isActive ? "group-hover:scale-110 transition-transform" : ""} />
              </div>
        ...
        >
          {({ isActive }) => (
            <>
              <div className={`${isActive ? "bg-white text-systemYellow-400" : "text-brandNeutral-text"} p-2 rounded-full transition-colors`}>
                <Award size={20} className={!isActive ? "group-hover:scale-110 transition-transform" : ""} />
              </div>
