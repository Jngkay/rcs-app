    ...
    return (
        <div className="speech-result-container">
            <div className="mt-8 bg-white rounded-lg shadow-md p-6">
                ...
                {/* Stats Box */}
                <div className="grid grid-cols-3 gap-4 bg-gray-50 border rounded-md p-6 text-center mb-6">
                    <div>
                    ...
                    <div>
                    <p className="text-xs text-gray-500 tracking-wide">ACCURACY:</p>
                    <p className="text-2xl font-bold text-blue-700">
                        {Math.max(
                        0,
                        Math.round(
                            ((totalOriginalWords - missingWordsCount) /
                            totalOriginalWords) *
                            100
                        )
                        )}
                ...
                <div className="border rounded-md p-5 mb-6">
                    ...
                    {diffResult.map((part, index) => {
                        ...
                        return (
                            <span
                            key={index}
                            className="bg-orange-400 text-white px-1 rounded mx-1"
